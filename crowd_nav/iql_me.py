...
class TrainConfig:
    ...
    checkpoints_path: Optional[str] = "D:\Program Files (x86)\IDE\JetBrains\PycharmProjects\CrowdNav-master_danren\crowd_nav\data\output_iql"  # Save path
...
def eval_actor(
    ...
    parser.add_argument('--env_config', type=str, default='D:\Program Files (x86)\IDE\JetBrains\PycharmProjects\CrowdNav-master_danren\crowd_nav\configs\env.config')
...
#     parser = argparse.ArgumentParser('Parse configuration file')
#     parser.add_argument('--env_config', type=str, default='/hd_2t/czx/project/CrowdNav/crowd_nav/configs/env.config')
#     args = parser.parse_args()
#     actor.eval()
#     env_config = configparser.RawConfigParser()
#     env_config.read(args.env_config)
...
#     avg_reward = 0
#     for _ in range(n_episodes):
#         observation = env.reset(phase=phase)
#         done = False
#         rewards = 0
#         gamma = 1  # 折扣因子
#         while not done:
